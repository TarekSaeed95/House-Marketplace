...
function AddingAds() {
  ...
  // uploading all data to firestore db     
    ...
    if(!discountedPrice){delete formDataCopy.discountedPrice}
  ...
  <div className="head-text mb-4">
    ...
    <h2 className='subhead-title text-primary'>Create new Ad</h2>
    </div>
   ...
   {offer && <div className="Price flex gap-3 items-center mb-4">
    ...
    <p className='text-secondry'>First image will be cover,(max 6)</p>
      ...
      <input className='form-control rounded-2xl border-0 px-4 py-3 w-fit
       ...
       <button className="btn btn-info bg-sky-600 text-white font-bold text-2xl w-1/2 block m-auto">Publish</button>
</form>
  </div>
</div>)
}
